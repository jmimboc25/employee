...
class EmployeeManagementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('employees-mgmt/create', ['departments' => $departments, 'divisions' => $divisions]);
    }
    ...
    public function edit($id)
    {
        ...
        $departments = Department::all();
        $divisions = Division::all();
        return view('employees-mgmt/edit', ['employee' => $employee,'departments' => $departments, 'divisions' => $divisions]);
    }
